...
def predict_for_next_day(df, target_date, is_Treasury=False):
    """
    ...
    predictions_df['trd_exctn_dt'] = target_date 
    # if not is_Treasury else 'Date' this was previosuly placed in the line above 
